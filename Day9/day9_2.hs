...
calc ('!':_:rest) garbage =  calc rest garbage -- the skip operator needs to fetch with highest priority
calc ('>':rest) _ =  calc rest False -- end garbage operator before garbage catchall
